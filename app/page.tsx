          ...
          <div className="container">
            <div className="hero-grid">
              <div className="reveal">
                ...
                <p>
                  I'm Lawrence Cortes, a BS Information Technology student based in Ormoc City, Leyte, Philippines. I
                  pair full-stack development — React, Next.js, Node.js, REST APIs — with the documentation discipline I
                  built supporting a government accounting office: precise, organized, and built to hold up under
                  process.
                </p>
                <p>
          ...
          <div className="container">
            ...
            <div className="proj-grid">
              <div className="proj-card reveal">
                ...
                <h3>CORTES Engineering Portfolio</h3>
                <p>
                  This site. A dark, component-driven portfolio built to present projects, skills, and certifications
                  in one place — and to keep getting rebuilt as the stack improves.
                </p>
                <a
                  className="proj-link"
                  href="https://cortes-engineering-portfolio.onrender.com"
                  target="_blank"
                  rel="noopener"
                >
                  View live site
              ...
              <div className="proj-card reveal">
                ...
                <h3>CORTES-Engineering-Portfolio (repo)</h3>
                <p>
                  Source for the portfolio above — open for review: structure, components, and how the site is put
                  together end to end.
                </p>
                <a
                  className="proj-link"
              ...
              <div className="proj-card reveal">
                ...
                <h3>AutoCertification AI</h3>
                <p>
                  An AI-powered certificate generation platform that automatically inserts recipient names into custom
                  certificate templates, eliminating repetitive manual editing. Designed to help schools, organizations,
                  and event coordinators generate large batches of personalized certificates quickly, accurately, and
                  efficiently.
                </p>
                <a
                  className="proj-link"
                  href="https://autocertificationai.onrender.com/"
                  target="_blank"
                  rel="noopener"
                >
                  View live site
              ...
              <div className="proj-card reveal">
                ...
                <p>
                  A Telegram bot that helps users stay organized by automating reminders and follow-ups. Ideal for
                  students, professionals, and busy individuals who want a simple way to manage tasks, deadlines, and
                  daily responsibilities directly from Telegram.
                </p>
                <a
                  className="proj-link"
                  href="https://web.telegram.org/a/#8905888956"
                  target="_blank"
                  rel="noopener"
                >
                  View Telegram Link
              ...
              <div className="proj-card reveal">
                ...
                <h3>Trash4Cash Barcode System</h3>
                <p>
                  A barcode-based recycling rewards platform where students earn canteen credits by returning
                  recyclable waste. The system promotes proper waste management, encourages environmental
                  responsibility, and provides schools with an engaging way to incentivize sustainable behavior.
                </p>
                <a
                  className="proj-link"
                  href="https://github.com/crisantohcortes1-commits/-Trash4CashBarcode"
                  target="_blank"
                  rel="noopener"
                >
                  View repository
              ...
              <div className="proj-card reveal">
                ...
                <h3>Student Self-Grading App</h3>
                <p>
                  A grade prediction and academic planning tool that allows students to input their Written Works,
                  Performance Tasks, and Project scores to estimate their final grade. It also calculates the scores
                  needed in upcoming assessments to reach a target grade, helping students make informed decisions
                  and improve academic performance.
                </p>
                <a
                  className="proj-link"
                  href="https://github.com/crisantohcortes1-commits/studentself_gradingapp"
                  target="_blank"
                  rel="noopener"
                >
                  View repository
              ...
              <div className="proj-card proj-cta reveal">
